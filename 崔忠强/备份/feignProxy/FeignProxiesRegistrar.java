...
class FeignProxiesRegistrar implements ImportBeanDefinitionRegistrar,
			...
			for (BeanDefinition candidateComponent : candidateComponents) {
				if (candidateComponent instanceof AnnotatedBeanDefinition) {
					...
					if (interfaceClass != null) {
						...
						enhancer.setCallback(new FeignProxyInvocationHandler(new Object()));
						...
						if (logger.isInfoEnabled()) {
							logger.info("Feign client {} proxy by {}", interfaceClass, proxy);
						}
					}
				}
			}
	...
	public String getQualifier(Map<String, Object> client) {
		if (client == null) {
			return null;
		}
